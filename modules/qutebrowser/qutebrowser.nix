  ...
  in {
    home-manager.users.jacob = {
      programs.qutebrowser = {
        ...
        # Note:
        # This extraConfig is necessary because the tabs.padding option is buggy in this home-manager module
        extraConfig = ''
      ...
      # Bookmarks
      xdg.configFile."qutebrowser/bookmarks/urls".text = bm.bookmarks;
